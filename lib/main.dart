...
class Todo {
  ...
  final List pregunta111; final List pregunta112;         //pregunta111 = ["Pregunta ", "¿Esto es una pregunta?", 0, "Sí, es una pregunta", "No, no es una pregunta"],
...
void main() {
  ...
  List pregunta111; List pregunta112;         //pregunta111 = ["Pregunta ", "¿Esto es una pregunta?", 0, "Sí, es una pregunta", "No, no es una pregunta"],
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        initialRoute: "home",
        routes: {
          "home": (_) => AnswerPage(items: items, key: key),
        }
    );
  }
}